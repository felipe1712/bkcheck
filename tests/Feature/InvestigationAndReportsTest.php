...
class InvestigationAndReportsTest extends TestCase
{
    ...
    public function test_trigger_investigation_routes_correctly()
    {
        ...
        // Since it is persona_fisica, it dispatches 10 queries (excluding marcas which applies to persona_moral only):
        // curp, rfc, csd, sat_listas, sanciones, litigios, presencia_en_linea, denue, selfie, identidad_digital
    ...
    public function test_pdf_report_generates_and_streams_successfully()
    {
        ...
        $queries = SourceQuery::where('subject_id', $subject->id)->get();
        // persona_moral: rfc, csd, siger, sat_listas, marcas, sanciones, litigios, presencia_en_linea, denue, identidad_digital = 10
        $this->assertCount(10, $queries);
