    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- Super Admin Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('superadmin.dashboard')); ?>">
                        <i class="ri-dashboard-2-line"></i> <span>Dashboard Global</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('superadmin.tenants.index')); ?>">
                        <i class="ri-git-repository-private-line"></i> <span>Clientes</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('superadmin.users.index')); ?>">
                        <i class="ri-group-line"></i> <span>Usuarios</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('superadmin.activity-logs')); ?>">
                        <i class="ri-file-list-3-line"></i> <span>Bitácora de Actividad</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('superadmin.audit-logs')); ?>">
                        <i class="ri-shield-keyhole-line"></i> <span>Auditoría de Consultas</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('superadmin.api-logs')); ?>">
                        <i class="ri-code-s-slash-line"></i> <span>Log de APIs</span>
                    </a>
                </li>
                <?php endif; ?>

                <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'tenant_admin|investigador')): ?>
                <!-- Tenant Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('tenant.dashboard')); ?>">
                        <i class="ri-dashboard-line"></i> <span>Inicio</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('tenant.projects.index')); ?>">
                        <i class="ri-folder-open-line"></i> <span>Proyectos</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('tenant.subjects.index')); ?>">
                        <i class="ri-user-search-line"></i> <span>Sujetos (Consultas)</span>
                    </a>
                </li>
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'tenant_admin')): ?>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('tenant.users.index')); ?>">
                        <i class="ri-group-line"></i> <span>Usuarios</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('tenant.consumption')); ?>">
...
<?php /**PATH C:\laragon\www\Atlas\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>